...
Provides a gamified learning experience, as reading lessons and completing quizzes allows students to earn points which can be redeemed for MINGA points, used during priority for course scheduling, final exam exemptions, and much more! Note: Code uses Vercel for domain hosting.
